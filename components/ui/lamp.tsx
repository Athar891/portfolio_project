...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center justify-start w-full z-0 min-h-screen overflow-x-hidden bg-slate-950",
        className
      )}
    >
      <div className="fixed top-0 left-0 right-0 flex h-96 w-full scale-y-125 items-center justify-center isolate z-0 pointer-events-none">
        <div
          style={{
